...
insert into card_tags (card_id, tag_id) values (@card_id, @tag_id1);
insert into card_tags (card_id, tag_id) values (@card_id, @tag_id2);
...
insert into card_tags (card_id, tag_id) values (@card_id, @tag_id1);
insert into card_tags (card_id, tag_id) values (@card_id, @tag_id2);
insert into card_tags (card_id, tag_id) values (@card_id, @tag_id3);
